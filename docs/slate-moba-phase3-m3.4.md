...
**Status:** queued. Start only after corrective PR #28 is squash-merged from its exact green head and
post-merge `main` is green. Phase 4 remains blocked until this slate closes.
...
- [ ] PR #28 is squash-merged from its recorded exact green head; local and origin `main` agree.
- [ ] Post-merge Debug, RelWithDebInfo, Release, and CodeQL checks are green.
