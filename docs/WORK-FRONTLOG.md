...
| 5a | **M5.5 `m5-lane-objectives`** — minion waves, towers, objectives on the M5.0 lanes | plan to write from the merged `main` (`plans/m5-lane-objectives.md`); fence `engine/sim/` objective files | open — next claim after #71 |
