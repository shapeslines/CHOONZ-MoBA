...
- **Now:** <one paragraph>
- **Not yet:** <one paragraph>

## Up next

- <the next durable slice, not the FIRST action on the resume pin>

## Pointers

- Resume pin: [docs/next-session.md](next-session.md)
- Sequence: [docs/ROADMAP.md](ROADMAP.md)
- Tickets: [docs/WORK-FRONTLOG.md](WORK-FRONTLOG.md)
