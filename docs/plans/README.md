...
| P1 / P2 Netcode spine | M5.2 command system, M6.0 reject reasons | `m5-command-replay` | `slice-m5-input-quantization` (partial) | [m5.1-command-replay.md](m5.1-command-replay.md) | `engine/sim/` command files, `tests/sim/command_replay_tests.cpp` | M3.4 replay/hash ✅ | in review — PR #69 |
| P4 / P5 Content scale | M4.1 successor (typed payloads) | `content-typed-payloads` | `slice-m4-offline-asset-cooker` | [content-typed-payloads.md](content-typed-payloads.md) | `engine/assets/`, `engine/asset_parsers/`, `tools/cooker/`, `tests/assets/` | M4.1 ✅ | in review — PR #70 (ADR-0016) |
| P4 Gameplay | M5.3 abilities, M5.4 combat | `m5-hero-combat` | — | [m5-hero-combat.md](m5-hero-combat.md) (on PR #71) | `engine/sim/` hero/combat files | #68, #69 | in review — PR #71 |
| P4 Gameplay | M5.5 minion/tower AI | `m5-lane-objectives` | — | [m5-lane-objectives.md](m5-lane-objectives.md) (on PR #72) | `engine/sim/` objective files | hero-combat (#71) | in review — PR #72 |
| P4 Gameplay | first playable | `game-content-bridge` | — | (plan to write after #72) | `engine/game/`, `tests/game/` | #70 content + #72 sim | next claim |
