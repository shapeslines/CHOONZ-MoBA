...
// M5.0 contract key: first 64 bits of SHA-256 over
// "M5.0|ordered-cache|damage-event-v1|same-tick|explicit-schedule-v1|map-grid-v1".
// (M3.2 key was 0xab96814425ba80a4 over the same string without the map term; the
// canonical state hash now covers the MapGrid block after Health.)
static const uint64_t SIM_LOGIC_HASH = 0xcef8548df2b2a518ULL;
